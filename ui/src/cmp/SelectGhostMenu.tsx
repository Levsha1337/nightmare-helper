...
import { calcAffect, Modifier, ModifierAffects, ModifierInfluence } from '../data/Modifier';
        ...
        return (
            <div className="select-ghost-menu">
                {GhostList.map((ghost) => {
                    ...
                    let modifiersAffect = calcAffect(GhostListTools.calculateModifiersAffect(ghost, this.props.modifiers));

                    if (!possibleGhostCodes.includes(ghost.codeName) || modifiersAffect.influence === ModifierInfluence.EXCLUDES) {
